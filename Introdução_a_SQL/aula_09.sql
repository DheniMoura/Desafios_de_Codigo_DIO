...
-- vemos que a busca está percorrendo todas as linhas 
EXPLAIN
 SELECT * FROM usuarios WHERE nome = 'João Silva';

 -- criando um índice para a coluna nome
 CREATE INDEX idx_nome 
ON usuarios (nome);

-- refazendo a consulta, percebemos que apenas duas linhas foram lidas
EXPLAIN
 SELECT * FROM usuarios WHERE nome = 'João Silva';
